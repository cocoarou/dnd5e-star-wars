...
- (a) armatura reticolata | (b) armatura da combattimento ed uno scudo leggero
...
Possiedi un numero di punti forza pari al tuo livello da guardiano x 2 (come indicato nella tabella) + il tuo modificatore di Carisma o Saggezza (scegli tu). Utilizzi questi punti forza per lanciare i poteri della forza. Recuperi tutti i punti forza spesi quando completi un riposo lungo.
...
Quando colpisci una creatura con un attacco corpo a corpo con l'arma puoi spendere punti forza per infliggere danni aggiuntivi al bersaglio. Il tipo di danno e' lo stesso dell'arma. I danni aggiuntivi ammontano ad 1d8 per punto potere speso. Non puoi infliggere piu' danni di quelli indicati nella colonna Colpi Focalizzati della tabella del guardiano.
...
Ottieni un'aura a scelta da [questa sezione](./Auree%20del%20Guardiano.md#auree-del-guardiano). Guadagni delle auree ulteriori ai livelli successivi come indicato nella colonna Auree Conosciute della tabella del guardiano. La tua aura ha un raggio di 1.5m che aumenta ai livelli successivi come indicato nella colonna Raggio dell'Aura della tabella del guardiano.
...
Ogni volta che colpisci una creatura con un attacco corpo a corpo con l'arma, subisce 1d8 danni dello stesso tipo di danno dell'arma
