- [Modifiche della Meccano-armatura](#modifiche-della-meccano-armatura)
  ...
  - [Scudi Elettroshock](#scudi-elettroshock)
  - [Volo](#volo)
  ...
  - [Sovraccaricare Scudi](#sovraccaricare-scudi)
  - [Pugno Energetico](#pugno-energetico)
  - [Prototipo di Pugno Energetico](#prototipo-di-pugno-energetico)
  - [Sottofondo Rinforzato](#sottofondo-rinforzato)
  - [Resistenza](#resistenza)
  - [Armatura Sigillata](#armatura-sigillata)
  - [Armatura Senziente](#armatura-senziente)
  - [Amplificatore di Scudi](#amplificatore-di-scudi)
...
**Prerequisiti:** livello 11, Prototipo di [Pugno Energetico](#pugno-energetico)
...
- Azione: non richiede un'azione
- Effetto: scegli tra i tipi di danno: acido, freddo, fuoco, ioni, elettricita' o sonico. Ottieni resistenza al tipo di danno scelto.
- Durata: finche' indossi l'armatura modificata
...
- Azione: 1 azione bonus
- Effetto: ottieni una scorta d'ossigeno per 1h e divieni immune al veleno (non cura esistenti condizioni di avvelenamento). L'armatura recupera 1 minuto di riserva d'ossigeno per ogni minuto che spendi fuori dall'acqua ed in cui l'armatura non e' sigillata. Inoltre, finche' indossi l'armatura modificata, sei considerato acclimato al caldo, al freddo ed alle altitudini.
- Durata: finche' indossi l'armatura modificata
...
- Azione: 1 azione bonus
- Effetto: fino all'inizio del tuo prossimo turno, ogni creatura che si trova 1.5m da te guadagna un bonus alla CA pari al bonus conferito dagli scudi.
- Utilizzi: 2
- Utilizzi ai livelli superiori: al 5 (3 tot), al 9 (4 tot) al 13 (5 tot) ed al 17 (6 tot)
- Recupero utilizzi: completamento di un riposo lungo
