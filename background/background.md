...
### Tratto: Rifugio Sicuro <!-- omit in toc -->
...
1 set di abiti comuni con cappuccio, 1 strumento da gioco (a scelta), una sacchetta legata alla cinta, contenente 150 cr

### Specialita' Criminale  <!-- omit in toc -->
...
### Tratto: Contatto Criminale <!-- omit in toc -->
...
2 a scelta tra: dotazione da artigiano, strumento da gioco, strumenti musicali
...
### Tratto: Rifugio del Fedele <!-- omit in toc -->
